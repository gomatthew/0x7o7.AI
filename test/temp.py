...
# vn = VannaDefault(model='chinook', api_key='a33ea2366f1743d69cba03bbbc2637ac')
# vn.connect_to_sqlite('https://vanna.ai/Chinook.sqlite')
# vn.ask('What are the top 10 artists by sales?')
# # vn.ask('who is the best sales?')
...
class MyVanna(VannaDB_VectorStore, MyCustomLLM):
    def __init__(self, config=None):
        MY_VANNA_MODEL = 'faiss' # Your model name from https://vanna.ai/account/profile
